...
- **Product Name Accuracy (CRITICAL):** You **MUST** use the **Exact Product Name** returned by the tool.
  ...
  - **Link Mapping:** For **"Invest Protect Goal III"**, ALWAYS use this link: `http://localhost:8000/brochures/Bajaj_invest-protect-goal-sl.pdf`.
  - **Link Mapping:** For **"Param Raksha Life Pro +"**:
     - Brochure: `http://localhost:8000/brochures/Tata-AIA-Param-Raksha-Life-Pro-plus-Leaflet07.pdf`
     - Policy Document: `http://localhost:8000/policy_documents/Tata-AIA-Param-Raksha-Life-Pro-plus-Policy-Document.pdf`
  - **Link Mapping:** For **"Bajaj Allianz Life eTouch Term Plan"**:
     - Brochure: `http://localhost:8000/brochures/Bajaj_E_Touch_Brochure_be609e8a64.pdf`
     - Policy Document: `http://localhost:8000/policy_documents/etouch-policy-document-116N172V03.pdf`
  - **Link Mapping:** For **"Axis Max Life Insurance - Smart Secure Plus Plan"** or **"Smart Secure Plus Plan"**:
     - Brochure: `http://localhost:8000/brochures/Axis_SSPP_Leaflet_97519a5f54.pdf`
     - Policy Document: `http://localhost:8000/policy_documents/Axis_max_life_smart_secure_plus_plan_prospectus_147c9617eb.pdf`
...
- **Brochure, Policy Document, & Report Links (CRITICAL):**
  ...
  - **Validation:** All links MUST start with `http://localhost:8000/`. If not, do not display.
...
async def chat_endpoint(request: ChatRequest):
    try:
        ...
        def calculate_insurance_plan(age: int, income: float, smoker: bool, gender: str, dob: str, cover_type: str, policy_type: str, liabilities: float = 0.0, is_rop: bool = False, city: str = "Not Specified", occupation: str = "Not Specified", education: str = "Not Specified", name: str = "Valued Client", sum_assured: str = "N/A"):
            ...
            try:
                ...
                try:
                    ...
                    # Add link to result
                    local_url = f"http://localhost:8000/reports/{filename}" # Update link to /reports
        ...
        if has_report_link and not tool_generated_link:
            ...
            cleaned_text = re.sub(r"\[Download Personalized Report\]\(http://localhost:8000/client_reports/Client_Report_.*?\.pdf\)", 
